      ...
      {c.loading ? (
        ...
        <>
          <div className="stat-tiles">
            <div className="stat-tile"><b>{c.classrooms.length}</b><span>My Classes</span></div>
            <div className="stat-tile"><b>{c.totalStudents}</b><span>Total Students</span></div>
            {c.lesson && <div className="stat-tile"><b>{c.lesson.topics.length}</b><span>Lesson Topics</span></div>}
          </div>
