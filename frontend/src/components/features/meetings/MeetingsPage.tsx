...
const typeTone: Record<MeetingItem["type"], BadgeTone> = {
    Scheduled: "accent",
    Pending: "amber",
    Done: "green",
};
...
export default function MeetingsPage() {
    ...
    const cols = [
        ...
        { key: "room", header: "Room" },
        {
            key: "type",
            header: "Status",
            render: (r: MeetingItem) => <Badge tone={typeTone[r.type]}>{r.type}</Badge>,
        },
    ];
    ...
    return (
        <div>
            <PageHeader
                title="Meetings"
                subtitle="Book and manage parent-teacher meetings, staff syncs and reviews."
            />
                        ...
                        <Card title="Book a parent-teacher meeting">
                            ...
                            <div className="modal-actions">
                                <Button
                                    variant="primary"
                                    onClick={() =>
                                        toast.push("success", "Slot booked — parent notified.")
                                    }
                                >
                                    Book slot
                                </Button>
