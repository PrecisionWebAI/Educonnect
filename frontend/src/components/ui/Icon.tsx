...
const PATHS: Record<IconName, React.ReactNode> = {
    attendance: (
        <>
            ...
            <path d="M6.2 19c.4-1.8 1.8-3 3.3-3s2.9 1.2 3.3 3" />
        </>
    ),
    wallet: (
        <>
    ...
    groups: (
        <>
            ...
            <path d="M15.8 19c.4-2.2 1.8-3.6 3.7-3.6 1 0 1.9.4 2.5 1.1" />
        </>
    ),
    students: (
        <>
            <circle cx="12" cy="8" r="3.2" />
            <path d="M5 20c.7-3.6 3.6-6 7-6s6.3 2.4 7 6" />
        </>
    ),
    guardian: (
        <>
            <circle cx="9" cy="8.5" r="2.8" />
            <path d="M4 19c.5-2.8 2.5-4.5 5-4.5s4.5 1.7 5 4.5" />
            <circle cx="17" cy="10" r="2.2" />
            <path d="M15.5 19c.3-2 1.6-3.4 3.5-3.4.9 0 1.7.3 2.3.9" />
        </>
    ),
    school: (
        <>
    ...
    bus: (
        <>
            ...
            <path d="M4 11h16M7 20v-3M17 20v-3M7 17h10" />
